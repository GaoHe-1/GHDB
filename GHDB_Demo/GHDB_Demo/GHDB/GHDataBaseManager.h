...
/** 修改你的数据库名称和版本 */
#define dataBaseName @"app.sqlite"



#pragma mark -  创建数据库
@interface GHDataBaseManager : NSObject
...
#pragma mark -  数据库初始化
@interface GHDataBaseManager (CreateDataBaseTable)
...
#pragma mark -  数据库表单操作
@interface GHDataBaseManager (OperationSQLiteTable)
